...
export WANDB_RUN_GROUP=progressive
export WANDB_RUN_NOTES="running progressive with task ${TASK}"
rm -rf output/progressive_${TASK}
...
--master_port=1234 \
--use_env \
-m baselines.progressive.train \
--seed 2 \
--cfg Salesforce/T5_base_prefix_${TASK}.cfg \
--run_name progressive_${TASK} \
...
--output_dir output/progressive_${TASK} \
...
--fp16_opt_level O2 \
--do_restart \
--vocab_weight_path data/weight/${TASK}.pk \
--debug_mode ${DEBUG}
