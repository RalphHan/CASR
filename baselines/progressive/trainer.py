...
class ProgressiveSeq2SeqTrainer(transformers.trainer_seq2seq.Seq2SeqTrainer):
    def __init__(
            self,
            evaluator,
    ...
    def train_all(self):
        ...
        for cascade_step in range(self.args.max_cascade_steps):
            ...
            if cascade_step>0 or not self.args.start_from_first_castep:
                ...
                del state_dict
            self.train_dataset.cascade_step=cascade_step+1
            if self.eval_dataset is not None:
                self.eval_dataset.cascade_step=cascade_step+1
            ...
            self.test_dataset.cascade_step = cascade_step + 1
            self.model.cascade_step = cascade_step+1
