...
export WANDB_RUN_GROUP=${EXP_NAME}_finetune_restart_nonauto
...
rm -rf output/${EXP_NAME}_T5_base_finetune_${TASK}_restart_nonauto
...
--run_name T5_base_finetune_${TASK}_restart_nonauto \
...
--output_dir output/${EXP_NAME}_T5_base_finetune_${TASK}_restart_nonauto \
