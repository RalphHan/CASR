...
export WANDB_RUN_GROUP=${EXP_NAME}_finetune_restart
...
rm -rf output/${EXP_NAME}_T5_base_finetune_${TASK}_restart
...
--run_name T5_base_finetune_${TASK}_restart \
...
--output_dir output/${EXP_NAME}_T5_base_finetune_${TASK}_restart \
